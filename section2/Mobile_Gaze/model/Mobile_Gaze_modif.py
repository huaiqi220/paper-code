...
class mobile_gaze_2d(nn.Module):
    ...
    # 这里的cali_vec是一个10维的二进制向量，共有1024种可能
    def forward(self, face, left, right, grid, cali_vec):
        ...
        fc2_input = torch.cat((cali_vec,fc1_output),dim=1)
        gaze_heatmap = self.fc2(fc2_input)
        return c, gaze_heatmap


if __name__ == "__main__":
    feature = {"face": torch.randn(10,3,112,112),"left":torch.randn(10,3,224,224),"right":torch.randn(10,3,224,224),"grid":torch.randn(10,1,25,40),"cali":torch.randn(10,10)}
    mobile = mobile_gaze_2d(32,10,25*40)
