...
'''
torchrun --nnodes=1 --nproc_per_node=5 --rdzv_id=100 --rdzv_backend=c10d --rdzv_endpoint=localhost:29401 train.py
...
def trainModel():
    ...
    label_path = os.path.join(root_path,"Label","K_Fold_diff", config.cur_k,"train")
