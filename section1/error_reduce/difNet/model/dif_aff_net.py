...
class difaffnet(nn.Module):
    def __init__(self):
        super(difaffnet, self).__init__()
        self.model = model()
    ...
    def forward(self,image1,image2):
        eyesLeft1, eyesRight1, faces1, rects1 = image1[0],image1[1],image1[2],image1[3]
        eyesLeft2, eyesRight2, faces2, rects2 = image2[0],image2[1],image2[2],image2[3]   
        feature1 = self.model(eyesLeft1, eyesRight1, faces1, rects1)
        feature2 = self.model(eyesLeft2, eyesRight2, faces2, rects2)
        fc_f = torch.cat([feature1,feature2],dim=1)
        gaze = self.fc(fc_f)
        return gaze
...
if __name__ == '__main__':
    ...
    image1,image2 = [feature["leftEyeImg"], feature["rightEyeImg"], feature["faceImg"], feature["faceGridImg"]],[feature["leftEyeImg"], feature["rightEyeImg"], feature["faceImg"], feature["faceGridImg"]]
    a = m(image1,image2)
    
    print(a.shape)
    from thop import profile
    flops, params = profile(m,inputs=(image1,image2,))
    print(f'FLOPs: {flops}')
